    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('save', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='mainApp.save')),
            ],
        ),
        migrations.CreateModel(
            name='PlayerSeason',
        ...
        migrations.AddField(
            model_name='player',
            name='save',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='mainApp.save'),
        ),
    ]
